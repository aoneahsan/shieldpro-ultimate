...
export const MARKETING_CONFIG = {
  ...
  MESSAGES: {
    EARLY_ADOPTER_WELCOME:
      'Welcome, Early Adopter! You have lifetime access to all premium features.',
    EARLY_ADOPTER_REMINDER:
      'As an early adopter, secure your lifetime benefits by creating an account.',
