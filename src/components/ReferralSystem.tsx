    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              >
                <svg
                  className="w-5 h-5 mx-auto text-blue-700"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              >
                <svg
                  className="w-5 h-5 mx-auto text-orange-500"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <div className="text-2xl font-bold text-purple-600">{referralStats.pendingRewards}</div>
            <div className="text-xs text-gray-500">Needed for Tier 4</div>
          </div>
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <div className="text-2xl font-bold text-green-600">{referralStats.tier4Progress}%</div>
      ...
      <div className="mt-4 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-200">
        <h4 className="text-sm font-medium text-amber-900 mb-2">🎁 Referral Rewards</h4>
