...
export const LayoutSwitcher: React.FC<LayoutSwitcherProps> = ({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Layout Style</h3>
        ...
        {layouts.map((layout) => {
          ...
          return (
            ...
            >
              ...
              <Icon
                className={`w-8 h-8 mb-2 ${isActive ? 'text-primary-600 dark:text-primary-400' : 'text-gray-600 dark:text-gray-400'}`}
              />

              <h4
                className={`font-medium text-sm mb-1 ${isActive ? 'text-primary-600 dark:text-primary-400' : 'text-gray-900 dark:text-gray-100'}`}
              >
                {layout.label}
              </h4>
